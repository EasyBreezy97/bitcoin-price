...
const Prices = (props) => {
  ...
  let list = '';
  if(currency === 'USD'){
    list =  <li className="list-group-item">Bitcoin rate for {props.bpi.USD.description}
    : <span className="badge badge-primary">{props.bpi.USD.code}</span>{' '}
    <strong>{props.bpi.USD.rate}</strong>
  </li>
  }else if(currency === 'GBP'){
    list =  <li className="list-group-item">Bitcoin rate for {props.bpi.GBP.description}
    : <span className="badge badge-primary">{props.bpi.GBP.code}</span>{' '}
    <strong>{props.bpi.GBP.rate}</strong>
  </li>
  }else if(currency ==='EUR'){
    list =  <li className="list-group-item">Bitcoin rate for {props.bpi.EUR.description}
